...
def logistic(y1, y0=df.Constant(1.), k=Constant(1.0)):
    """ 
    The logistic function. y0 is the y-value of the sigmoids midpoint.
    k controls the steepness of the curve. 
    """
    return constant(1.) / (Constant(1.) +  df.exp(-k*(y1 - y0))) 
